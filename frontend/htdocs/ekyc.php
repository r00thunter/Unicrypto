                            ...
                            <div class="LayoutDesktop__Content-flhQBc kuJaHF Flex__Flex-fVJVYW gkSoIH">
                                <div class="Panel__Container-hCUKEb ejcVRF">
                                    ...
                                    <div class="Accounts__HeightWrapper-bIafrT bjqSJc Flex__Flex-fVJVYW iJJJTg">
                                      ...
                                      <center> Please click the link to upload your KYC documents <a target="_blank" href="<?=  $ekcy['auto_login_url'] ?>">Link</a></center></div>
                                    </div>
                                    <?php } else { ?>
                                        <div class="Accounts__HeightWrapper-bIafrT bjqSJc Flex__Flex-fVJVYW iJJJTg">
                                        <div style="padding:14% 38%">
                                      <center> Your eKYC status :  <span style="color:#2E7BC4;text-transform:uppercase" ><?= $ekyc_data[0]->status ?> </span> 
                                      <? if($ekyc_data[0]->status=='rejected'){ ?>
                                      <span >please submit correct / clear documents again <a target="_blank" href="<?=  $ekcy['auto_login_url'] ?>">Link</a></span>
                                      <? } ?>
                                    </center></div>
                                    </div>
                                    <?php } ?>
