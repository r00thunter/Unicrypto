...
{
	include '/var/www/html/frontend/lib/common.php';
	echo '<form action="" method="post" id="user_trans_frm" name="user_trans_frm">';
	...
	echo '<td style="padding:10px;">:</td>';
	echo '<td style="padding:10px;" colspan="2"><input style="width: 500px;" type="text" value="buy" name="side"></td>';
	echo '</tr>';
...
?>
<script type="text/javascript">
// document.getElementById("user_trans_frm").submit();
</script>