...
{
	include '/var/www/html/frontend/lib/common.php';
	echo '<form action="" method="post" id="withdraw_get_frm" name="withdraw_get_frm">';
	...
	echo '<td style="padding:10px;">:</td>';
	echo '<td style="padding:10px;" colspan="2"><input style="width: 500px;" type="text" value="'.$_SESSION['nonce'].'" name="nonce" id="nonce"></td>';
	echo '</tr>';
	...
	echo '<td style="padding:10px;">:</td>';
	echo '<td style="padding:10px;" colspan="2"><input style="width: 500px;" type="text" value="" name="address"></td>';
	echo '</tr>';		
	echo '<tr>';
	echo '<td style="padding:10px;">BANK ACCOUNT NUMBER</td>';
	echo '<td style="padding:10px;">:</td>';
	echo '<td style="padding:10px;" colspan="2"><input style="width: 500px;" type="text" value="" name="account_number"></td>';
	echo '</tr>';		
	}
	...
	<select style="width: 500px;" name="status">
