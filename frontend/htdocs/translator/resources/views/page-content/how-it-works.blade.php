...
<div class="row page-row">
    <div class="justify-content-center page">
        ...
        @endif
            <br><br><br><h4 class="page-title">About Us</h4>
            ...
            @if($page_content_count<1)
                <form class="modal-form" method="POST" id="orders" action="{{ route('howit.content.store') }}" enctype="multipart/form-data">
            @else
                <form class="modal-form" method="POST" id="orders" action="{{ route('howit.content.edit') }}" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    @foreach($language as $languagevlue)
                        ...
                        <?php
                            ...
                            $pges_content = '';
                            if (isset($pge_content->$symbol->how_it_works_heading_key)) {
                        ...
                        <input type="text" class="form-control" id="menu_name" placeholder="Enter Your Page" name="how_it_works_{{$languagevlue->language_symbol}}_heading_key"  value="@if($pges_content){{$pges_content->how_it_works_heading_key}}@endif">
                  
                        <!-- {{$title++}} -->
                    @endforeach
                        
                    <input type="hidden" class="form-control"   id="s" placeholder="Enter Your Heading" name="how_it_works_heading_key" required value="how_it_works_heading_key">
                </div>
              </div>
                  ...
                  <div class="row">
                    ...
                    @foreach($language as $languagevlue)
                        ...
                        <?php
                            ...
                            $symbol = (string) $languagevlue->language_symbol;
                            $pges_content = '';
                            if (isset($pge_content->$symbol->how_it_works_content_key)) {
                                // print_r($pge_content->$symbol);
                                $pges_content = $pge_content->$symbol;
                            }
                        ...
                        <label for="name">Content ({{$languagevlue->language_symbol}})</label>
                         <textarea name="how_it_works_{{$languagevlue->language_symbol}}_content_key" class="form-control" id="content{{$title}}">@if($pges_content){{$pges_content->how_it_works_content_key}}@endif</textarea>
                    ...
                    <input type="hidden" class="form-control"   id="s" placeholder="Enter Your Heading" name="how_it_works_content_key_key" required value="how_it_works_content_key">
