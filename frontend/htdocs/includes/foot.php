...
<div class="footer">
    ...
    <div class="container">
   		...
   		<div class="one_fourth">
            ...
            <div class="footer_logo"><img src="images/logo1.png" width="100"alt="" /></div>
...
<div class="copyright_info">
    <div class="container">
        <div class="one_half">
            ...
            <b>Copyright &copy; 2018 <?= Lang::string('site_name') ?>. All rights reserved.</b>
            <br/>
            <b>mail:<?= Lang::string('site_email') ?></b>
...
<a href="https://www.messenger.com/t/gentleninja.org" class="fb-msg-btn-chat" target="_blank">Questions? Contact us on Facebook.</a>
</div>
</div>
