...
<head>
	...
	<base href="<?= ($CFG->chat_baseurl) ? $CFG->chat_baseurl : $CFG->baseurl ?>" />
	
	<meta charset="utf-8">
	<meta name="keywords" content="" />

	<meta name="description" content="<?= (!empty($meta_desc) ? $meta_desc : false) ?>" />
	<meta name="publisher" content="BitExchange OpenSource Crypto Exchange" />
...
<header id="header">
	...
	<div class="wrapper">
     ...
     <div class="container">
		...
		<!-- Logo -->
		<div class="one_fourth"><a href="index.php" id="logo" style="color: #000;
    font-size: 30px !important;display: inline-block;top: 15px;
    margin: 0;">
              <h1><?= $CFG->exchange_name; ?></h1>
        </a></div>
                ...
                <ul id="tiny">
                    ...
                    <li><a href="account.php" <?= ($CFG->self == 'account.php' || $CFG->self == 'open-orders.php' || $CFG->self == 'transactions.php' || $CFG->self == 'security.php' || $CFG->self == 'settings.php' || $CFG->self == 'bank-accounts.php' || $CFG->self == 'bitcoin-addresses.php' || $CFG->self == 'history.php' || $CFG->self == 'api-access.php') ? 'class="active"' : '' ?>><?= Lang::string('account') ?> <i class="fa fa-angle-down"></i></a>
                        <ul>
							...
							<? } ?>
                            <li><a href="usersecurity.php"><?= Lang::string('security') ?></a></li>
                             <li>
                        <a href="#">General <i class="fa fa-angle-right" style="float: right;"></i></a>
                        <ul>
                             <li><a href="userprofile.php"><?= Lang::string('settings') ?></a></li>
                    ...
                    <li><a href="userapi.php"><?= Lang::string('api-access') ?></a></li>
                          
                        </ul>
                    </li>
                    <li><a href="userbuy.php?trade=BTC-USD" <?= ($CFG->self == 'userbuy.php') ? 'class="active"' : '' ?>><?= Lang::string('buy-sell') ?></a></li>
