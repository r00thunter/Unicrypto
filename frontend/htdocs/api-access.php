		...
		<div class="testimonials-4">
			...
			<div class="content1">
				...
				<div class="mar_top3"></div>
           		<div class="clear"></div>
				<ul class="list_empty">
					<li><a class="btn but_user" href="mysecurity.php"><?= Lang::string('api-setup-security') ?></a></li>
				</ul>
				<div class="clear"></div>
			</div>
			<? } elseif ($request_2fa) { ?>
					...
					<div class="buyform">
						<div class="one_half row">
							...
							<div class="form-group col-md-4">
								...
								<input type="submit" name="submit" value="<?= Lang::string('security-validate') ?>" class="btn form-control">
								<? if (User::$info['using_sms'] == 'Y') { ?>
								<input type="submit" name="submit" value="<?= Lang::string('security-resend-sms') ?>" class="btn form-control">
								<? } ?>
							</div>
			...
			<form id="add_bank_account" action="api-access.php" method="POST">
		    	...
		    	<div class="info-table-outer">
		    		<table id="info-data-table " class="table-list trades table row-border table-hover balance-table" cellspacing="0 " width="100% ">
		    			<thead>
						<tr>
...
<script>
          ...
          // $("body#wrapper").css("background","#03040B !important");
