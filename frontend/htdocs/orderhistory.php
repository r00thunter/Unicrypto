...
<html lang="en">
    ...
    <body id="wrapper">
        ...
        <?php
        $page_sql=mysqli_query($conn_l, "select id from trans_page where page_status=1 and page_name='order history'");
        ...
        <header>
            <div class="banner row">
                <div class="container content">
                    <h1><?php echo isset($pgcont['order_history_heading_key']) ? $pgcont['order_history_heading_key'] : 'Order Table'; ?></h1>
                    <p class="text-white text-center"><?php echo isset($pgcont['order_history_sub_heading_key']) ? $pgcont['order_history_sub_heading_key'] : 'Buy / Sell Open Orders of the entire Exchange'; ?></p>
                </div>
            </div>
        </header>
            ...
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <form action="" class="form-inline" style="padding: 20px;background: white;margin-top: 20px;">
                            <div class="form-group">
                                <label for="sel1" style="font-size: 12px;"><?php echo isset($pgcont['order_history_currency_pair_key']) ? $pgcont['order_history_currency_pair_key'] : 'Currency Pair'; ?> &nbsp;</label>
                            </div>
                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <br>
                        <center>
                            <h5><?php echo isset($pgcont['order_history_buy_order_key']) ? $pgcont['order_history_buy_order_key'] : 'Buy Orders'; ?></h5>
                        </center>
                        <div class="info-table-outer">
                            <table  id="info-data-table " class="table row-border info-data-table table-hover balance-table" cellspacing="0 " width="100% ">
                                <thead>
                                    <tr>
                                        <th><?php echo isset($pgcont['order_history_table_head_type_key']) ? $pgcont['order_history_table_head_type_key'] : 'Type'; ?></th>
                                        <th><?php echo isset($pgcont['order_history_table_head_price_key']) ? $pgcont['order_history_table_head_price_key'] : 'Price'; ?></th>
                                        <th><?php echo isset($pgcont['order_history_table_head_amount_key']) ? $pgcont['order_history_table_head_amount_key'] : 'Amount'; ?></th>
                                        <th><?php echo isset($pgcont['order_history_table_head_value_key']) ? $pgcont['order_history_table_head_value_key'] : 'Value'; ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?
                                        ...
                                        echo '<tr id="no_bids" style="' . ((is_array($bids) && count($bids) > 0) ? 'display:none;' : '') . '"><td></td><td></td><td>No BUY orders are open.</td><td></td><td></td>';
                                        ?>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <br>
                        <center>
                            <h5><?php echo isset($pgcont['order_history_sell_order_key']) ? $pgcont['order_history_sell_order_key'] : 'Sell Orders'; ?></h5>
                        </center>
                        <div class="info-table-outer">
                            <table  id="info-data-table1 " class="table row-border info-data-table table-hover balance-table" cellspacing="0 " width="100% ">
                                ...
                                <tbody>
                                    <?
                                        ...
                                        echo '<tr id="no_asks" style="' . ((is_array($asks) && count($asks) > 0) ? 'display:none;' : '') . '"><td></td><td></td><td>No SELL orders are open.</td><td></td><td></td></tr>';
                                        ?>
                                </tbody>
                            </table>
                        </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo isset($pgcont['order_history_currency_pair_modal_head_key']) ? $pgcont['order_history_currency_pair_modal_head_key'] : 'Order Table'; ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p><?php echo isset($pgcont['order_history_currency_pair_modal_content_key']) ? $pgcont['order_history_currency_pair_modal_content_key'] : 'Select the correct Currency pairs from the dropdown to display their successful transaction details'; ?>.</p>
        
        <p><?php echo isset($pgcont['order_history_currency_pair_modal_amount_key']) ? $pgcont['order_history_currency_pair_modal_amount_key'] : '<b>Amount:</b>The number of cryptocurrencies purchased'; ?>.</p>
        
        <p><?php echo isset($pgcont['order_history_currency_pair_modal_value_key']) ? $pgcont['order_history_currency_pair_modal_value_key'] : '<b>Value:</b> The cost of the cryptocurrency purchased'; ?>. </p>
        
        <p><?php echo isset($pgcont['order_history_currency_pair_modal_price_key']) ? $pgcont['order_history_currency_pair_modal_price_key'] : '<b>Price:</b> The per unit price of the Cryptocurrency purchased (Shown in USD)'; ?></p>
        
        <p><?php echo isset($pgcont['order_history_currency_pair_modal_fee_key']) ? $pgcont['order_history_currency_pair_modal_fee_key'] : '<b>Fee:</b> The fee levied by the Exchange for each transaction'; ?>.</p>
      </div>
    </div>
  </div>
</div>
