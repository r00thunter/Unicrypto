...
if ($account1 > 0) {
	...
	if (!is_array(Errors::$errors)) {
		...
		Link::redirect('bank-accounts.php?show=add');
		$bank_accounts = $query['BankAccounts']['get']['results'][0];
	}
}
...
<body class="app signed-in static_application index" data-controller-name="static_application" data-action-name="index" data-view-name="Coinbase.Views.StaticApplication.Index" data-account-id="">
  <div id="root">
    ...
    <div class="container content">
        <h1>Bank Accounts</h1>
         <p style="text-align: center;color: #fff;">Add, Manage and View your bank account details.</p>
    </div>
</div>
                ...
                <div class="LayoutDesktop__Content-flhQBc kuJaHF Flex__Flex-fVJVYW gkSoIH">
                  <div class="description-box" style="    border: 1px solid #DAE1E9;padding: 10px;margin: 0 0 1em;border-radius: 4px;">
                    ...
                    <ol>
                      ...
                      <li>View and manage all your Bank account details.</li>
                    </ol>
                </div>
                  <div id="myModal" class="modal">
                    <div class="modal-content">
                      ...
                      <h3>
                        <u><?= Lang::string('bank-accounts-add-label') ?>
                        </u>
                      </h3>
                      <?Errors::display();?>
                      
                      <form id="add_deposit" action="bank-accounts.php" method="POST">
                        <input type="hidden" name="action" value="add">
                        <div class="TradeSection__Wrapper-jIpuvx bskbTZ">
                          <div class="TradeSection__Label-bicWvY CrFOg Flex__Flex-fVJVYW gsOGkq">
                            <h4 class="Heading__StyledHeading-sALAQ hwfHDH" style="font-size: 18px;">Account Holder Name
                            </h4>
                          </div>
                          <div>
                        ...
                        <!-- <div class="TradeSection__Wrapper-jIpuvx bskbTZ">
                          <div class="TradeSection__Label-bicWvY CrFOg Flex__Flex-fVJVYW gsOGkq">
                            <h4 class="Heading__StyledHeading-sALAQ hwfHDH" style="font-size: 18px;">Pan Number
                            </h4>
                          </div>
                          <div>
                            <div class="Flex__Flex-fVJVYW gkSoIH">
                              <div class="form-group">
                                <input type="text" class="form-control" name="pan_no" value="<?php echo User::$info['pan_no']; ?>" >
                              </div>
                            </div>
                          </div>
                        </div> -->
                        <div class="TradeSection__Wrapper-jIpuvx bskbTZ">
                          <div class="TradeSection__Label-bicWvY CrFOg Flex__Flex-fVJVYW gsOGkq">
                            <h4 class="Heading__StyledHeading-sALAQ hwfHDH" style="font-size: 18px;">Bank Name
                            </h4>
                          </div>
                          <div>
                            <div class="Flex__Flex-fVJVYW gkSoIH">
                        ...
                        <div class="TradeSection__Wrapper-jIpuvx bskbTZ">
                          <div class="TradeSection__Label-bicWvY CrFOg Flex__Flex-fVJVYW gsOGkq">
                            <h4 class="Heading__StyledHeading-sALAQ hwfHDH" style="font-size: 18px;">Ifsc Code
                            </h4>
                          </div>
                          <div>
                            <div class="Flex__Flex-fVJVYW gkSoIH">
                        ...
                        <div class="TradeSection__Wrapper-jIpuvx bskbTZ">
                          <div class="TradeSection__Label-bicWvY CrFOg Flex__Flex-fVJVYW gsOGkq">
                            <h4 class="Heading__StyledHeading-sALAQ hwfHDH" style="font-size: 18px;"> <?= Lang::string('bank-accounts-description') ?>
                            </h4>
                          </div>
                          <div>
                            <div class="Flex__Flex-fVJVYW gkSoIH">
                        ...
                        <div class="TradeSection__Wrapper-jIpuvx bskbTZ">
                          <div class="TradeSection__Label-bicWvY CrFOg Flex__Flex-fVJVYW gsOGkq">
                            <h4 class="Heading__StyledHeading-sALAQ hwfHDH" style="font-size: 18px;"> <?= Lang::string('bank-accounts-currency') ?>
                            </h4>
                          </div>
                          <div>
                            <div class="Flex__Flex-fVJVYW gkSoIH">
                    ...
                    echo '<option '.(($currency['id'] == $currency1 || (!$currency1 && $currency['currency'] == 'USD')) ? 'selected="selected"' : '').' value="'.$currency['id'].'">'.$currency['currency'].'</option>';
                        ...
                        <button type="submit" class="Button__Container-hQftQV kZBVvC" style="cursor: pointer;">
                          <div class="Button__Content-eaBvLU iOGmBb Flex__Flex-fVJVYW iDqRrV">
                            <div class="Flex__Flex-fVJVYW ghkoKS">Add 
                            </div>
                          </div>
                        </button>
                      </form>
                  ...
                  <div class="Panel__Container-hCUKEb ejcVRF">
                    <div class="Accounts__Header-kUlsOz hjYHLC Flex__Flex-fVJVYW hQXxaf">
                      <h4 class="Heading__StyledHeading-sALAQ hwfHDH" style="font-size: 18px;">
                        <span>Your Bank Accounts
                        </span>
                      </h4>
                      <span style="float:right" id="myBtn">
                          <a href="javascript:void(0);" class="gVLEBI" style="border-color: #1166d1;color: #1166d1;"><?= Lang::string('bank-accounts-add') ?></a>
                        </span>
                    </div>
                      ...
                      <div class="Accounts__AccountListWrapper-hJZLkd fzpAGl Flex__Flex-fVJVYW iDqRrV">
                        <div class="AccountList__AccountsList-eEZOms jZdQTT Flex__Flex-fVJVYW gkSoIH">
                          <a class="AccountList__AccountLink-cGluzb bnXidV">
                            <div class="AccountListItem__Account-laXKDv jIylJE CFlex__Flex-fVJVYW iDqRrV">
                                  ...
                                  <div class="AccountListItem__Details-cWizxw GENJj Flex__Flex-fVJVYW bHipRv">
                                    ...
                                    <div>
                                      <span class="Text__Font-jgIzVM gJaRtZ" color="slateDark">
                                        <span>
                                          $ <?= Stringz::currency($user_available['USD']) ?>
                                        </span>
                                      </span>
                                    </div>
                                    <div class="AccountListItem__Actions-bsqZNF fNrJZo Flex__Flex-fVJVYW iDqRrV">
                                      <div class="Flex__Flex-fVJVYW ghkoKS">
                                        ...
                                        <button  onclick="location.href='withdraw'" class="AccountActionButtons__AccountButton-ejRNLb hOLrOE Button__Container-hQftQV gVLEBI" id="withdraw">
                                          <div class="Button__Content-eaBvLU iOGmBb Flex__Flex-fVJVYW iDqRrV">
                        ...
                        <!-- <div class="Accounts__FooterLink-bzmsMV kjoxfT Flex__Flex-fVJVYW hBrjIA" >
                           
                          <div id="myBtn">
                          <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" class="Accounts__PlusIcon-YOjBG cBaRUg">
                            <path d="M15.93 7.55h-6v-6c0-.6-.4-1-1-1s-1 .4-1 1v6h-6c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1v-6h6c.6 0 1-.4 1-1s-.4-1-1-1z">
                            </path>
                          </svg>
                          <span ><?= Lang::string('bank-accounts-add') ?>
                          </span>
                        </div>
                            ...
                            <div class="TransactionListItem__LinkContainer-dcvOgD cNJUjb Flex__Flex-fVJVYW hBrjIA">
                              <div class="Flex__Flex-fVJVYW reCYb">
                                <div class="TransactionListItem__DateContainer-gqotRI eoNrlE Flex__Flex-fVJVYW jmXzPI">
								  ...
								  <?= Lang::string('bank-accounts-account') ?>
                                  </div>
                                ...
                                <div class="Flex__Flex-fVJVYW jYOuLK">
                                  <div class="TransactionListItem__TransactionTitle-hrYDmM nDuUc Flex__Flex-fVJVYW iDqRrV"><?= Lang::string('bank-accounts-currency') ?>
                                  </div>
                                  <div class="TransactionListItem__TransactionSubtitle-CAWdv doKCBi Flex__Flex-fVJVYW reCYb"><?= $account['currency'] ?>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="Flex__Flex-fVJVYW jvHpwe">
                                  <div class="TransactionListItem__TransactionTitle-hrYDmM nDuUc Flex__Flex-fVJVYW iDqRrV">
                                    <span>
                                      ...
                                      <?= Lang::string('bank-accounts-description') ?>
                                    </span>
                                  </div>
                                </div>
                                <div class="Flex__Flex-fVJVYW jvHpwe">
                    ...
                    <div class="Footer__Right-iFQtJS cGVJJy Flex__Flex-fVJVYW reCYb">
                      ...
                      <!-- <div class="Footer__SelectWrapper-fEXIsO kxbyEA">
                        <select class="Select__SelectWrapper-fXiYlv THIro" name="locale">
                          ...
                          <option value="es-mx">Español - Méjico
                          </option>
                          ...
                          <option value="pt-br">Português - Brazil
                          </option>
                        </select>
                      </div> -->
