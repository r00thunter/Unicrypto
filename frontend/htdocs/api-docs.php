...
$code['api_url'] = 'https://bitexchange.cash/api';
...
<?php include "includes/sonance_navbar.php"; ?>
 ...
 <?php
        $page_sql=mysqli_query($conn_l, "select id from trans_page where page_status=1 and page_name='api'");
     ...
     <header>
         <div class="banner row">
            <div class="container content">
               <h1><?php echo isset($pgcont['api_heading_key']) ? $pgcont['api_heading_key'] : $page_title; ?></h1>
            </div>
         </div>
      </header>
...
<div class="container">
    ...
    <div class="text2"><?php echo isset($pgcont['api_content_key']) ? $pgcont['api_content_key'] : $content['content']; ?></div>
    </div>
