...
class Lang {
	...
	public static function url($url=false,$get_alts=false,$get_js=false) {
		...
		$urls['index.php']['pt'] = 'pt/index.php';
		$urls['order-book.php']['en'] = 'userexchange.php';
		...
		$urls['order-book.php']['pt'] = 'pt/libreta-de-ordenes.php';
		...
		$urls['contact.php']['pt'] = 'pt/contacte-nos.php';
		...
		$urls['register.php']['pt'] = 'pt/inscrever-se.php';
		...
		$urls['our-security.php']['pt'] = 'pt/nossa-seguranca.php';
		...
		$urls['buy-and-sell-bitcoin.php']['pt'] = 'pt/comprar-e-vender-bitcoins.php';
		...
		$urls['fee-schedule.php']['pt'] = 'pt/taxas-e-comissoes.php';
		...
		$urls['about.php']['pt'] = 'pt/sobre-nos.php';
		...
		$urls['what-are-bitcoins.php']['pt'] = 'pt/o-que-sao-bitcoins.php';
		...
		$urls['how-bitcoin-works.php']['pt'] = 'pt/como-funciona-o-bitcoin.php';
		...
		$urls['reset_2fa.php']['pt'] = 'pt/reiniciar_2fa.php';
		...
		$urls['press-releases.php']['pt'] = 'pt/comunicados-de-imprensa.php';
		...
		$urls['terms.php']['pt'] = 'pt/termos.php';
