...
class BankAccounts{
	...
	public static function insert($account, $currency, $description=false, $ifsc, $bank_name , $name) {
		global $CFG;
		...
		db_insert('bank_accounts',array('account_number'=>$account,'currency'=>$currency,'description'=>$description,'site_user'=>User::$info['id'], 'ifsc_code' => $ifsc , 'bank_name' => $bank_name , 'name' => $name));
	}
	...
	public static function get_private_api($currency_id=false,$session_user=false) {
		global $CFG;
	...
	public static function getRecord_private_api($id=false,$account_number=false,$session_user=false) {
		global $CFG;
