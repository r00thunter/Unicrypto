...
if (cluster.isMaster) {
	...
	socket.on('connect', function (data) {
		...
		parseCFG(function (cfg) {
			console.log("CFG = ",cfg) ;
			console.log('CRYPTO CAPITAL PK = ',cfg.crypto_capital_pk );
